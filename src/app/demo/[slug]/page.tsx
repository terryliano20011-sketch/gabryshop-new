...
const DEMOS: Record<string, {
  ...
  ristorazione: { categorySlug:'ristorazione',
  ...
  bellezza: { categorySlug:'bellezza',
  ...
  artigiani: { categorySlug:'artigiani',
  ...
  professionisti: { categorySlug:'professionisti',
  ...
  automazioni: { categorySlug:'automazioni',
  ...
  business: { categorySlug:'business',
  ...
  creativita: { categorySlug:'creativita',
          ...
          <div>
            ...
            <div style={{marginBottom:'28px'}}>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
                {demo.products.map(p => (
                  <Link key={p.name} href={`/categoria/${demo.categorySlug}`} style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 16px',background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:'12px',textDecoration:'none',transition:'all 0.2s'}}>
            ...
            <Link href={`/categoria/${demo.categorySlug}`} style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'14px 28px',background:`linear-gradient(135deg,${demo.color},${demo.color}cc)`,color:'#08060a',borderRadius:'100px',textDecoration:'none',fontFamily:'Outfit,system-ui,sans-serif',fontSize:'14px',fontWeight:700}}>
              Acquista ora →
            </Link>
          </div>
