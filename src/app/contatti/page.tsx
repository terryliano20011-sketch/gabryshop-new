      ...
      <div style={{maxWidth:'1100px',margin:'0 auto',padding:'0 6%'}}>
        ...
        <div className="grid-contatti">
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
            {[
              {icon:<MessageCircle size={18}/>, label:'WhatsApp', value:'Risposta entro 1 ora', href:`https://wa.me/393518435322`, color:'#25D366'},
              {icon:<Mail size={18}/>,          label:'Email',    value:'gabryshop7@gmail.com',  href:'mailto:gabryshop7@gmail.com', color:'#c9a96e'},
