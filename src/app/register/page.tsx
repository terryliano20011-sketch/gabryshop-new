    ...
    <div style={{minHeight:'100vh',background:'#000',display:'flex',alignItems:'center',justifyContent:'center',padding:'40px 6%'}}>
      <div style={{width:'100%',maxWidth:'420px'}}>
        ...
        <div style={{textAlign:'center',marginBottom:'40px'}}>
          ...
          <h1 style={{fontFamily:'Cormorant Garamond,serif',color:'white',fontSize:'2.2rem',fontWeight:600,marginBottom:'8px'}}>Registrati</h1>
          <p style={{fontFamily:'Outfit,system-ui,sans-serif',color:'rgba(120,120,155,0.6)',fontSize:'14px'}}>Crea il tuo account GabryShop</p>
        </div>
        ...
        <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:'20px',padding:'32px',display:'flex',flexDirection:'column',gap:'18px'}}>
          <div>
            <label style={{fontFamily:'Outfit,system-ui,sans-serif',fontSize:'11px',fontWeight:700,letterSpacing:'0.12em',textTransform:'uppercase',color:'rgba(120,120,155,0.6)',display:'block',marginBottom:'8px'}}>Nome e Cognome</label>
            <input className="g-input" type="text" placeholder="Mario Rossi" value={name} onChange={e=>setName(e.target.value)}/>
          </div>
          <div>
          ...
          <div>
            ...
            <input className="g-input" type="password" placeholder="Min. 8 caratteri" value={password} onChange={e=>setPassword(e.target.value)}/>
          </div>
          ...
          <p style={{fontFamily:'Outfit,system-ui,sans-serif',fontSize:'11px',color:'rgba(100,100,135,0.5)',textAlign:'center',lineHeight:1.6}}>
            Registrandoti accetti i{' '}
            <Link href="/termini" style={{color:'#4dd9c0',textDecoration:'none'}}>Termini</Link>
            {' '}e la{' '}
            <Link href="/privacy" style={{color:'#4dd9c0',textDecoration:'none'}}>Privacy Policy</Link>
          </p>
        </div>

        <p style={{textAlign:'center',marginTop:'20px',fontFamily:'Outfit,system-ui,sans-serif',fontSize:'13px',color:'rgba(100,100,135,0.55)'}}>
          Hai già un account?{' '}
          <Link href="/login" style={{color:'#4dd9c0',textDecoration:'none',fontWeight:600}}>Accedi</Link>
        </p>
      </div>
    </div>
  )
